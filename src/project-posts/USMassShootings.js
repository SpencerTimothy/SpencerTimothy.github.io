...
const USMassShootings = () => {
  return (
    ...
    <div className="writings">
      ...
      <p>An analysis of mass shootings in the United States from 1982 - 2022</p>
      <img
        style={{ width: "60rem" }}
      ...
      <p>
        ...
        potential risk factors that may contribute to these events. To help shed
        light on this issue, this study aims to analyze data from the{" "}
        <a
      ...
      <p>
        The dataset contains details on different aspects of each mass shooting,
        such as the number of victims, incident location, and type of weapon
        employed. Notably, the Mother Jones dataset defines a mass shooting as
        an incident in which three or more people are killed. Nevertheless, it
        is worth noting that other sources may have slightly different
        definitions.
      </p>
      <p>
        ...
        incidents. Additionally, a geospatial visualization of the dataset will
        be created to assist in a visual representation of the extent and
        distribution of mass shootings across the country. By mapping the
        location and number of victims in each incident, the visualization will
        provide a clear and detailed picture of the spatial patterns and trends
        of mass shootings.
      </p>
      <h2>Analysis</h2>
      <p>
        ...
        Pydeck, a relatively new library, is used for creating interactive maps
        with 3D rendering capabilities. Together, these libraries provide the
        necessary tools for exploring and presenting insights from the mass
        shooting dataset.
      </p>
      <p>
        As with any data project using pre-existing datasets, missing data can
        pose a challenge in accurately analyzing the information. In the case of
        this analysis, multiple data points were found to be missing, such as
        the number of injured, the total amount of victims, the age of the
        ...
        medical center shooting in 2022, the number of people injured had to be
        estimated due to incomplete data. Additionally, to determine the
      ...
      <p>
        For readers interested in the data cleaning and analysis methodology, it
        is recommended to refer to this{" "}
        <a
      ...
      <p>
        ...
        been increasing since the mid-1990s. In 2017, there were a total of 704
        victims, the highest number recorded, mainly due to the Las Vegas
      ...
      <p>
        ...
        consistent and prevalent location for mass shootings over the years. In
        fact, they have often been the most common location for such incidents.
        Locations labeled "other" are also frequently reported for mass
        shootings. However, shootings in the workplace have consistently been a
        popular location for mass shootings.
      </p>
      <img
        style={{ width: "40rem" }}
      ...
      <p>
        ...
        experienced the highest number of shootings, with 50 incidents, followed
        by schools with 20, and then "religious" sites with 8. The category
        labeled "other", which encompasses various locations not captured in the
        listed categories (such as parks, commercial properties, and
        bars/nightclubs), has the most mass shootings, totaling 52 incidents.
      </p>
      <h3>Prior Signs of Mental Health Issues</h3>
      <p>
        The following chart includes some values that were originally labeled as
        "Unclear" and "-". These labels were changed to "Unknown" during the
        data cleaning process to ensure consistency in the analysis.
      ...
      <p>
        ...
        exhibited early indications of mental health problems. Nevertheless, it
        is critical to note that a significant number of cases contained
        "unknown" or "unclear" details about the shooter's mental health
        background. This may imply that further research and data collection are
        necessary to better comprehend the link between mental health and mass
        shootings
      </p>
      <h3>Most Common Weapon Type</h3>
      <p>
        The following chart summarizes the weapon types used in mass shootings,
        after cleaning and simplifying the original data. The categories of
        "rifle" and "handgun" were originally classified under various names,
        such as "semi-automatic rifle", "semiautomatic rifle", "long gun",
        "semiautomatic handgun", "handguns", "revolver", and so on. To simplify
        the analysis, these categories were collapsed into three broad
        categories: "Rifle", "Handgun", and "Shotgun". Many of the mass
        shootings involved multiple weapon types, so they are categorized as
        "Handgun, Rifle", "Shotgun, Handgun", and so on. Although the weapon
        types were often not specified in detail, it is worth noting that both
        handguns and rifles were frequently categorized as "Semiautomatic".
      </p>
      <img
        style={{ width: "45rem" }}
      ...
      <p>
        The preceding chart analyzing weapon type usage in mass shootings in the
        United States highlights that "Handgun" was the most frequently used
        weapon, followed by a combination of "Handgun" and "Rifle". The use of
        just a "Rifle" was the third most commonly used weapon in these
        incidents. It is important to note that weapon types were often broadly
        categorized, such as "Semiautomatic Handgun" or "Semiautomatic Rifle",
        and there was no further research on the specific model or type of
      ...
      <p>
        ...
        distribution of these incidents and visualizing the areas that have been
        impacted by mass shootings.
      </p>
      <p>
        The interactive map presented below visualizes the location and
        magnitude of all mass shootings that have occurred in the United States
        from 1982 to 2022. The map is designed to provide a comprehensive
        overview of the distribution of these incidents across the country. Each
        column on the map represents a single shooting, with the height and
        color of the column indicating the number of victims in each incident.
      </p>
      <p>
        ...
        state where the incident occurred, the date it took place, and the total
        number of victims. This information provides a deeper understanding of
        the impact of these tragic events on communities across the United
        States.
      </p>
      ...
      <ul>
        <li>
          ...
          clicking, double tapping with a touchpad, or by using the <kbd>+</kbd>{" "}
          and <kbd>-</kbd> keys on the keyboard.
        </li>
        <li>
        ...
        <li>
          ...
          rotated) of the map can be changed by clicking and dragging the cursor
          while holding the{" "}
          <kbd>Ctrl</kbd> + the left mouse button and moving the cursor up/down
          (pitch) or left/right (bearing), or by holding the right mouse button
          and moving the cursor up/down or left/right.
        </li>
      </ul>
      <iframe
        style={{ width: "70rem" }}
      ...
      <p>
        ...
        for public health. The analysis shows that shooters in this dataset had
        a mean age of 33.61 years, with a majority being in their 20s. Over
        time, both the number of victims and mass shootings have increased, with
        the highest number of victims occurring in 2017 and the highest number
        of mass shootings occurring in 2022. The incidents predominantly took
        place in workplaces and schools, with a smaller number taking place at
        religious institutions and other public places. The data suggests that
        many shooters had prior indications of mental health issues, and the
        majority of them used handguns as their primary weapon.
      </p>
      <p>
        There were many additional questions addressed in the original analysis
        posted on GitHub. If the reader is interested in exploring these
        questions and the code used to analyze the data, I recommend viewing the
        analysis in the Notebook Viewer at the following
        <a
          href="https://nbviewer.org/github/SpencerTimothy/Mass-Shootings-in-the-United-States/blob/main/U.S.%20Mass%20Shootings.ipynb"
          target="_blank"
        >
